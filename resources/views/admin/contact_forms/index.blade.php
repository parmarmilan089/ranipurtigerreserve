                    ...
                    <tbody>
                        @foreach ($forms as $form)
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-2">
                                    <a href="{{ route('admin.contact-forms.show', $form->id) }}" class="text-blue-600 hover:underline">View</a>
                                    <form action="{{ route('admin.contact-forms.destroy', $form->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
